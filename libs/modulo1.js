const quizData = [
  ...
  {
    question: "How can companies benefit from monitoring supplier risk?",
    answers: [
      "By reducing procurement costs",
      "By increasing operational efficiency",
      "By avoiding supply chain disruptions",
      "By improving contract negotiations",
    ],
    correct: 2,
  },
  {
    question:
      "Which component is NOT part of the supplier risk assessment in SAP Ariba?",
    answers: [
  ...
  {
    question: "What does a risk heat map display?",
    answers: [
      "Supplier locations",
  ...
  {
    question: "Which action is part of risk mitigation strategies?",
    answers: [
      "Ignoring minor risks",
      "Transferring risk through insurance",
      "Accepting all risks",
      "Delaying response to risks",
    ],
    correct: 1,
  },
  {
    question: "Which risk is specifically related to supplier compliance?",
    answers: [
  ...
  {
    question:
      "What is the benefit of using automated risk assessment workflows?",
    answers: [
      "Increased data entry speed",
      "Consistent and repeatable risk assessments",
      "Reduced supplier negotiation time",
  ...
  {
    question:
      "Which feature helps in visualizing overall supplier risk in SAP Ariba?",
    answers: [
      "Supplier Scorecard",
  ...
  {
    question: "How does SAP Ariba Supplier Risk support supplier onboarding?",
    answers: [
      "By automating payment terms",
      "By evaluating and mitigating potential risks",
      "By tracking delivery schedules",
      "By managing inventory levels",
    ],
    correct: 1,
  },
  {
    question: "What is a key characteristic of operational risk?",
    answers: [
      "It relates to financial market fluctuations",
      "It involves supply chain disruptions",
      "It deals with regulatory compliance",
      "It focuses on contractual terms",
    ],
    correct: 1,
  },
  {
    question: "What is an example of a reputational risk?",
    answers: [
      "Supplier bankruptcy",
  ...
  {
    question:
      "How can SAP Ariba Supplier Risk help in supplier performance management?",
    answers: [
      "By setting up automated payments",
      "By providing insights into potential risks",
      "By creating supplier contracts",
      "By managing inventory stocks",
    ],
    correct: 1,
  },
  {
    question: "Which of the following is a financial risk indicator?",
    answers: [
      "Supplier location",
  ...
  {
    question:
      "Which feature allows tracking of regulatory changes impacting suppliers?",
    answers: [
      "Spend Analysis",
      "Risk Monitoring",
      "Supplier Onboarding",
  ...
  {
    question: "What kind of risks can external data sources help identify?",
    answers: [
  ...
  {
    question: "Which action is part of a risk response plan?",
    answers: [
      "Ignoring all risks",
  ...
  {
    question: "How does SAP Ariba Supplier Risk support risk scoring?",
    answers: [
      "By manual data entry",
      "By integrating supplier performance data",
      "By using third-party risk data",
      "By analyzing historical procurement data",
    ],
    correct: 2,
  },
  {
    question: "What is a proactive approach in supplier risk management?",
    answers: [
      "Reacting to issues after they occur",
      "Regularly monitoring and assessing risks",
      "Ignoring minor risks",
      "Focusing only on major suppliers",
    ],
    correct: 1,
  },
  {
    question:
      "Which tool can provide early warning of potential supplier issues?",
    answers: [
  ...
  {
    question: "Which SAP Ariba tool helps in ensuring supplier compliance?",
    answers: [
      "Spend Analysis",
      "Supplier Performance Management",
      "Supplier Risk",
  ...
  {
    question: "What type of risk can impact the supply chain directly?",
    answers: [
      "Financial risk",
      "Operational risk",
      "Reputational risk",
  ...
  {
    question:
      "What is the role of third-party risk data providers in SAP Ariba?",
    answers: [
      "To manage procurement transactions",
      "To provide external risk information",
      "To automate supplier payments",
      "To create supplier contracts",
    ],
    correct: 1,
  },
];
